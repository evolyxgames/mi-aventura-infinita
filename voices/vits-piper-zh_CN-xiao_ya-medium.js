export function loadData(Module) {
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'vits-piper-zh_CN-xiao_ya-medium.data';
      var REMOTE_PACKAGE_BASE = 'vits-piper-zh_CN-xiao_ya-medium.data';
...
Module['FS_createPath']("/", "vits-piper-zh_CN-xiao_ya-medium", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_vits-piper-zh_CN-xiao_ya-medium.data');
      }
      Module['addRunDependency']('datafile_vits-piper-zh_CN-xiao_ya-medium.data');
